...
coffee = Product.find_or_create_by(name: 'Cafetera Eléctrica', store_id: 1, price: 9990, link:'https://www.facebook.com/', clicks_cost: 20, category: coffee_makers, email: 'dummy@example.com', status: :approved)
coffee.image.attach(io: File.open('app/assets/products/cafetera2.jpg'), filename: "cafetera2.jpg")
coffee = Product.find_or_create_by(name: 'Cafetera Espresso', store_id: 1, price: 15990, link:'https://www.facebook.com/', clicks_cost: 20, category: coffee_makers, email: 'dummy@example.com', status: :approved)
...
chocolate = Product.find_or_create_by(name: 'Chocolates', store_id: 1, price: 4990, link:'https://www.facebook.com/', clicks_cost: 20, category: chocolates, email: 'dummy@example.com', status: :approved)
chocolate.image.attach(io: File.open('app/assets/products/chocolate.jpg'), filename: "chocolate.jpg")
chocolate = Product.find_or_create_by(name: 'Chocolate 2', store_id: 1, price: 9990, link:'https://www.facebook.com/', clicks_cost: 20, category: chocolates, email: 'dummy@example.com', status: :approved)
chocolate.image.attach(io: File.open('app/assets/products/chocolate2.jpg'), filename: "chocolate2.jpg")
chocolate = Product.find_or_create_by(name: 'Chocolate 3', store_id: 1, price: 15990, link:'https://www.facebook.com/', clicks_cost: 20, category: chocolates, email: 'dummy@example.com', status: :approved)
...
beer = Product.find_or_create_by(name: 'Cerveza simple', store_id: 1, price: 499, link:'https://www.facebook.com/', clicks_cost: 20, category: beers, email: 'dummy@example.com', status: :approved)
beer.image.attach(io: File.open('app/assets/products/cerveza1.jpg'), filename: "cerveza1.jpg")
beer = Product.find_or_create_by(name: 'Pack de cervezas (opción 1)', store_id: 1, price: 4990, link:'https://www.facebook.com/', clicks_cost: 20, category: beers, email: 'dummy@example.com', status: :approved)
beer.image.attach(io: File.open('app/assets/products/cerveza2.jpg'), filename: "cerveza2.jpg")
beer = Product.find_or_create_by(name: 'Pack de cervezas (opción 2)', store_id: 1, price: 19990, link:'https://www.facebook.com/', clicks_cost: 20, category: beers, email: 'dummy@example.com', status: :approved)
